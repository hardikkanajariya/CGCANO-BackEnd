            ...
            submit: function(e) {
                ...
                try {
                    ...
                    if (typeof error == "string") {
                        ...
                        console.error(error);
                        this.error(error.responseText || error.statusText || error.message || 'Unknown error!');
                    }
                    this.showForm();
                }
            },
    ...
    (function ($) {
        ...
        $.extend(Checklist.prototype, {
            ...
            value2str: function(value) {
                ...
                return (($.isArray(value) ? value.sort().join($.trim(this.options.separator)) : '') || this.sourceData.map(() => '').join($.trim(this.options.separator)))
            },
