...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_NAME', 'CGCANO-backup'),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'sudburycgcanogroup@gmail.com',
            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'Info@gcanorthernontario.com'),
                'name' => env('MAIL_FROM_NAME', 'CGCANO Backup'),
            ],
        ],
